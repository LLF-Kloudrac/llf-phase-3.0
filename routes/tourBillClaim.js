      ...
      if(typeof(bodyResult.arrival_Date) == 'object')
      {
          ...
          for(let i=0; i<numberOfRows ;i++)
          {
            ...
            const schema = joi.object({
              ...
              arrival_Station:joi.string().min(2).required().label(' Please select Arrival Station.'),
              departure_Station:joi.string().min(2).required().label('Please select Departure Station'),
