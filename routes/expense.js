    ...
    if(typeof(request.body.from) == 'object')
    {
        ...
        for(let i=0; i<numberOfRows ; i++)
        {
          const schema = joi.object({
            ...
            purpose:joi.string().min().required().label('Please enter Purpose of Travel'),
            purposeof: joi.string().min().max(255).required().label('Please enter Purpose of Travel, ranging from 1-255 Characters'),
